...
local function move(side,dist,digBool)
...
function initGPS(facingDirection)
    --Okay. So do i try to replace the turtle api
    -- or do i just use a seperate api?

    --... Due to how things have been going,
    --i will simply make myself have to handle the gps when i move.
    --oh well.
